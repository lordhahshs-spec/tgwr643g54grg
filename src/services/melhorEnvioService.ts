...
export const melhorEnvioService = {
   ...
   * e associa a etiqueta gerada e código de rastreamento oficial ao pedido
   */
  async createAndPurchaseLabel(orderId: string): Promise<{
    ...
    try {
      ...
      return { success: false, error: err.message || 'Erro de comunicação ao processar compra de envio no Melhor Envio.' };
    }
  },
